...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Vector2 HandTranslate
        {
            get
            {
                return SteamVR_Actions.default_HandTranslate;
            }
        }
        
        public virtual SteamVR_Action_Vector2 HandRotate
        {
            get
            {
                return SteamVR_Actions.default_HandRotate;
            }
        }
